...
function ensureReviewSemantics(result: ReviewOutput) {
  ...
  if (result.verdict === 'pass' && result.acceptanceChecks.some((check) => check.status !== 'pass')) {
    throw new Error('Review verdict pass requires all acceptance checks to pass')
  }
}

function toOpenAiOutputSchema(schema: typeof implementOutputSchemaInternal | typeof reviewOutputSchemaInternal) {
...
export const implementOutputSchema = toOpenAiOutputSchema(implementOutputSchemaInternal)
export const reviewOutputSchema = toOpenAiOutputSchema(reviewOutputSchemaInternal)
...
export type AcceptanceCheck = typeof import('./model').acceptanceCheckSchema['_output']
export type BlockedTaskState = typeof import('./model').blockedTaskStateSchema['_output']
...
export type ReviewFinding = typeof import('./model').reviewFindingSchema['_output']
export type ReviewOutput = typeof reviewOutputSchemaInternal['_output']
export type ReviewVerdict = typeof reviewOutputSchemaInternal['_output']['verdict']
export type ReplanTaskState = typeof import('./model').replanTaskStateSchema['_output']
export type ReworkTaskState = typeof import('./model').reworkTaskStateSchema['_output']
export type RunningStage = typeof import('./model').runningTaskStateSchema['_output']['stage']
export type RunningTaskState = typeof import('./model').runningTaskStateSchema['_output']
export type TaskDefinition = typeof import('./model').taskDefinitionSchema['_output']
export type TaskGraph = typeof taskGraphSchema['_output']
export type TaskState = typeof import('./model').taskStateSchema['_output']
export type TaskStatus = typeof import('./model').taskStateSchema['_output']['status']
export type VerifyArtifact = typeof verifyArtifactSchema['_output']
export type VerifyCommandResult = typeof import('./model').verifyCommandResultSchema['_output']
